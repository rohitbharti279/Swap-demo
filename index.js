...
async function getPrice() {
    ...
    const headers = { '0x-api-key': "c9f13c84-9fcb-4f42-aa30-a11b0d016aa5" }; // This is a placeholder. Get your live API key from the 0x Dashboard (https://dashboard.0x.org/apps)
...
async function trySwap() {
    ...
    const tx = await ERC20TokenContract.methods.approve(
        ...
        maxApproval,
    ).send({ from: takerAddress }).then(tx => {
